...
def fen_to_terminal_display(fen_string):
    '''Prints a FEN string into the terminal in the board format.
...
def import_fen_to_board(fen: str):
    ...
    chessboard.last_move_piece = pieces.Pawn('placeholder', turn_to_move, 100)
...
def export_board_to_fen(chessboard):
    ...
    for ind, sublist in enumerate(fen):
        partial_fen = []
